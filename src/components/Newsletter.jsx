...
const Newsletter = () => {
  ...
  return (
    <section
      id="newsletter"
      className="py-16 md:py-20 px-6 bg-[#2b2f36]" //
    >
      <div className="container mx-auto text-center max-w-2xl">
        ...
        >
          ...
          <button
            type="submit"
            className="bg-[#42A5F5] hover:bg-[#2196F3] text-white font-semibold py-3 px-6 rounded-full flex items-center justify-center space-x-2 transition"
          >
            <span>Subscribe</span>
            <svg
              className="w-5 h-5"
